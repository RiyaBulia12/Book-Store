...
const BookList = ({ bookList }) => (
  <div className="panel">
    ...
    {bookList.map((book) => (
      <div className="cards bg-white shadow-xl flex flex-row mb-5" key={book.id}>

        <div className="w-full">
          <div className="flex flex-col">
            <ul>
              <li className="genre m-0">{book.category}</li>
              <li className="title roboto m-0">{book.title}</li>
              <li className="author roboto slate-blue m-0">{book.author}</li>
            </ul>
          </div>
